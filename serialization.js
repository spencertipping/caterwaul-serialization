...
xi1<xl1;
 ++xi1)x1=xs1[xi1] , (encode_pair(x1) ) ;
return xs1} ) .call(this, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
...
return ref[2] = (function(xs1) {var x1,x01,xi1,xl1,xr1;
for(var xr1=new xs1.constructor() ,xi1=0,xl1=xs1.length;
xi1<xl1;
 ++xi1)x1=xs1[xi1] ,xr1.push( (encode(x1) ) ) ;
return xr1} ) .call(this,Array.prototype.slice.call( (v) ) ) } ;
...
for(var xi1=0,xl1=xs1.length;
xi1<xl1;
 ++xi1)x1=xs1[xi1] , (link_array_properties(x1) ) ;
return xs1} ) .call(this, (function(xs1) {var x1,x01,xi1,xl1,xr1;
for(var xi1=0,xl1=xs1.length;
xi1<xl1;
 ++xi1)x1=xs1[xi1] , (link_object_properties(x1) ) ;
return xs1} ) .call(this,serialized) ) ) } ) .call(this) } ,values= (function(it) {return(relink(xs,it) ) ,it} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
